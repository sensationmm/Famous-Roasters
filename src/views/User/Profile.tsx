        ...
        <div className={containerStyle}>
          <div className={`${sectionStyle}`}>
            ...
            <div className="grid w-full gap-y-8 md:grid-cols-2 md:gap-4">
              <div className="grid grid-cols-[150px_1fr] gap-4 border-b border-brand-grey-bombay md:max-w-sm md:border-0 pb-8">
              ...
              <div className="grid grid-cols-[150px_1fr] gap-4 md:max-w-sm md:pb-8">
